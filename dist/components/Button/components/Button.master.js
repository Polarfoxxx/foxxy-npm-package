...
var Button = function (_a) {
    ...
    /* servis pre style */
    var _b = services_1.default.changerStyleForButton({ variant: variant, border: border, round: round, lg: lg, sm: sm }), styles = _b.styles, defStyle = _b.defStyle, sizeElement = _b.sizeElement;
    return (React.createElement("button", __assign({}, props, { style: __assign(__assign(__assign({}, styles), defStyle), sizeElement) }), text));
};
