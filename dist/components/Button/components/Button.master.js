...
var Button = function (_a) {
    ...
    /* servis pre style */
    var _b = services_1.default.changerStyleForButton({ variant: variant, border: border, round: round, lg: lg, sm: sm }), variant_style = _b.variant_style, defStyle = _b.defStyle, sizeElement = _b.sizeElement;
